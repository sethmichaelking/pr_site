  ...
  return (
    <div>
        ...
        class="flex items-center flex-shrink-0 text-black mr-6">
            ...
            <a 
            href="/home"
            class="font-semibold text-xl tracking-tight">PulsePR</a>
        </div>
        ...
        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            ...
            <div>
            <a
            onClick={(e)=>goToContactForm(e)} 
            class="inline-block text-lg px-4 py-2 leading-none rounded text-black hover:border-transparent hover:cursor-pointer hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Contact Us</a>
            </div>
        </div>
        </nav>
